...
<!-- LADYB PRODUCT VIEW -->
@section('graphs') 
    <meta property ="og:url" content="http://commcycle.co/ladyB-product-view/{{$found->id}}"/> 
    ...
    <meta property="og:description" content="Check this out! It's R {{$found->Price}}. Posted by Lady-B, {{$found->created_at->diffForHumans()}}" />
@endsection
			...
			<div class='col-lg-3 col-md-3 col-sm-6 col-xs-12' style='margin-top:70px;'> 
				<div class='thumbnail ' style='padding:25px;'>
					<center>
						...
						<a href='/add-to-cart/ladyB/{{ $found->id }}' class='btn btn-success solid-two-light' style='width:90%;'><span class='fa fa-plus'></span> <span class='fa fa-shopping-cart'></span> Add to Cart</a>
